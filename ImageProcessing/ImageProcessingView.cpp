...
BEGIN_MESSAGE_MAP(CImageProcessingView, CView)
	...
	ON_WM_CONTEXTMENU()
	ON_WM_RBUTTONUP()
	ON_COMMAND(ID_DOWN_SAMPLE, &CImageProcessingView::OnDownSample)
...
ON_COMMAND(ID_GUASSIAN_FILTER, &CImageProcessingView::OnGuassianFilter)
...
void CImageProcessingView::OnDownSample()
{
...
void CImageProcessingView::OnGuassianFilter()
{
	CImageProcessingDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
